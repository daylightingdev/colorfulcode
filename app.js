...
const RS_BUILDINGS = [
  ...
  { address: '24 WEST 88TH STREET', borough: 'Manhattan', zip: '10024', units: 10, block: '1217', lot: '33', yearBuilt: 1900, lat: 40.7890, lng: -73.9705 },
  { address: '35 WEST 64TH STREET', borough: 'Manhattan', zip: '10023', units: 20, block: '1120', lot: '12', yearBuilt: 1925, lat: 40.7730, lng: -73.9795 },
  { address: '266 WEST 96TH STREET', borough: 'Manhattan', zip: '10025', units: 40, block: '1243', lot: '55', yearBuilt: 2024, lat: 40.7945, lng: -73.9720 },
  ...
  { address: '304 WEST 109TH STREET', borough: 'Manhattan', zip: '10025', units: 18, block: '1845', lot: '22', yearBuilt: 1920, lat: 40.8020, lng: -73.9635 },
  { address: '406 EAST 9TH STREET', borough: 'Manhattan', zip: '10009', units: 12, block: '450', lot: '18', yearBuilt: 1910, lat: 40.7275, lng: -73.9840 },

  // --- Brooklyn ---
  { address: '680 METROPOLITAN AVENUE', borough: 'Brooklyn', zip: '11211', units: 16, block: '2305', lot: '28', yearBuilt: 1920, lat: 40.7145, lng: -73.9510 },
  ...
  { address: '373 WYTHE AVENUE', borough: 'Brooklyn', zip: '11249', units: 32, block: '2325', lot: '48', yearBuilt: 2012, lat: 40.7130, lng: -73.9635 },

  // --- Queens ---
  { address: '34-05 33RD STREET', borough: 'Queens', zip: '11106', units: 18, block: '550', lot: '42', yearBuilt: 1930, lat: 40.7565, lng: -73.9185 },
  { address: '95-08 QUEENS BOULEVARD', borough: 'Queens', zip: '11374', units: 42, block: '3190', lot: '55', yearBuilt: 1948, lat: 40.7295, lng: -73.8645 },
  { address: '93-23 218TH STREET', borough: 'Queens', zip: '11428', units: 20, block: '10650', lot: '22', yearBuilt: 1955, lat: 40.7220, lng: -73.7405 },
  { address: '47-51 44TH STREET', borough: 'Queens', zip: '11377', units: 16, block: '1360', lot: '35', yearBuilt: 1935, lat: 40.7440, lng: -73.9205 },
  ...
  { address: '546 EAST 182ND STREET', borough: 'Bronx', zip: '10457', units: 24, block: '3050', lot: '15', yearBuilt: 1920, lat: 40.8560, lng: -73.8880 },
  { address: '735 WALTON AVENUE', borough: 'Bronx', zip: '10451', units: 30, block: '2425', lot: '42', yearBuilt: 1925, lat: 40.8285, lng: -73.9215 },
  { address: '2718 MORRIS AVENUE', borough: 'Bronx', zip: '10468', units: 28, block: '3240', lot: '22', yearBuilt: 1932, lat: 40.8660, lng: -73.8990 },
  { address: '1149 MORRIS AVENUE', borough: 'Bronx', zip: '10456', units: 18, block: '2480', lot: '35', yearBuilt: 1915, lat: 40.8345, lng: -73.9160 },
  { address: '222 EAST 202ND STREET', borough: 'Bronx', zip: '10458', units: 22, block: '3300', lot: '12', yearBuilt: 1930, lat: 40.8680, lng: -73.8870 },
];
...
const SAMPLE_LISTINGS = [
  ...
  },
  {
    ...
    url: 'https://streeteasy.com/building/24-west-88-street-new_york/br',
    address: '24 West 88th Street, #BR',
    borough: 'Manhattan', neighborhood: 'Upper West Side', zip: '10024',
    price: 2100, bedrooms: 0, bathrooms: 1,
    description: 'Rent-stabilized studio with private backyard. Hardwood floors throughout, charming walk-up on tree-lined street, steps from B/C subway.',
    availableDate: '2026-04-15',
    lat: 40.7890, lng: -73.9705,
  },
  {
    id: 'se-003', source: 'streeteasy',
    url: 'https://streeteasy.com/building/35-west-64-street-new_york/4f',
    address: '35 West 64th Street, #4F',
    borough: 'Manhattan', neighborhood: 'Lincoln Square', zip: '10023',
    price: 2650, bedrooms: 1, bathrooms: 1,
    description: 'True 1BR rent-stabilized apartment on quiet tree-lined block between Central Park and Lincoln Center. Recently renovated with stainless steel appliances, dishwasher, stone countertops. Live-in super, laundry in building.',
    availableDate: '2026-05-01',
    lat: 40.7730, lng: -73.9795,
  },
  {
  ...
  },
  {
    ...
    url: 'https://streeteasy.com/building/304-west-109-street-new_york/3d',
    address: '304 West 109th Street, #3D',
    borough: 'Manhattan', neighborhood: 'Upper West Side', zip: '10025',
    price: 1750, bedrooms: 0, bathrooms: 1,
    description: 'Charming rent-stabilized studio on quiet tree-lined block off 109th and Broadway.',
    availableDate: '2026-04-01',
    lat: 40.8020, lng: -73.9635,
  },

  // --- Brooklyn ---
  {
    id: 'se-007', source: 'streeteasy',
    url: 'https://streeteasy.com/building/680-metropolitan-avenue-brooklyn/1r',
    address: '680 Metropolitan Avenue, #1R',
    borough: 'Brooklyn', neighborhood: 'Williamsburg', zip: '11211',
    price: 2900, bedrooms: 2, bathrooms: 1,
    description: 'Rent-stabilized 2BR right on Metropolitan Ave in Williamsburg with spacious private backyard. Apartments in this building rarely available. Near cafes, restaurants, bars, L/G trains and buses.',
    availableDate: '2026-04-15',
    lat: 40.7145, lng: -73.9510,
  },
  {
  ...
  },
  {
    ...
    url: 'https://streeteasy.com/building/the-williamsburg/1b',
    address: '373 Wythe Avenue, #1B',
    borough: 'Brooklyn', neighborhood: 'Williamsburg', zip: '11249',
    price: 3100, bedrooms: 1, bathrooms: 1,
    description: 'Rent-stabilized 1BR with patio in modern Silver LEED building. Spacious floorplan with open kitchen, dishwasher, microwave, and noise abatement windows.',
    availableDate: '2026-04-01',
    lat: 40.7130, lng: -73.9635,
  },

  // --- Queens ---
  {
    id: 'se-014', source: 'streeteasy',
    url: 'https://streeteasy.com/building/33_02-34-avenue-astoria/b1',
    address: '34-05 33rd Street, #B1',
    borough: 'Queens', neighborhood: 'Astoria', zip: '11106',
    price: 1800, bedrooms: 1, bathrooms: 1,
    description: 'Rent-stabilized 1BR on second floor with separate kitchen, large living room, queen-size bedroom, newer bathroom, and two large closets. Two blocks from the station.',
    availableDate: '2026-04-15',
    lat: 40.7565, lng: -73.9185,
  },
  {
    id: 'se-015', source: 'streeteasy',
    url: 'https://streeteasy.com/building/95_08-queens-boulevard-rego_park/6k',
    address: '95-08 Queens Boulevard, #6K',
    borough: 'Queens', neighborhood: 'Rego Park', zip: '11374',
    price: 1995, bedrooms: 1, bathrooms: 1,
    description: 'Fully renovated 1BR in rent-stabilized building. Close to all amenities, elevator building with laundry, pet-friendly, gym available. Train half a block away.',
    availableDate: '2026-05-01',
    lat: 40.7295, lng: -73.8645,
  },
  {
  ...
  },
  {
    ...
    url: 'https://streeteasy.com/building/47_51-44-street-woodside/3front',
    address: '47-51 44th Street, #3FRONT',
    borough: 'Queens', neighborhood: 'Sunnyside', zip: '11377',
    price: 2100, bedrooms: 2, bathrooms: 1,
    description: 'Rent-stabilized spacious top-floor 2BR with ceiling fans throughout, natural light, eat-in kitchen, huge living room, and plenty of storage. Heat & hot water included. Less than 10 minutes to the 7 train. Small pets allowed.',
    availableDate: '2026-05-15',
    lat: 40.7440, lng: -73.9205,
  },
  {
  ...
  },
  {
    ...
    url: 'https://streeteasy.com/building/546-east-182-street-bronx/1a',
    address: '546 East 182nd Street, #1A',
    borough: 'Bronx', neighborhood: 'East Tremont', zip: '10457',
    price: 2200, bedrooms: 3, bathrooms: 1,
    description: 'Large rent-stabilized 3BR with hardwood floors, queen-sized bedrooms, large windows with excellent sunlight, and separate kitchen. Well maintained building close to transportation and supermarkets.',
    availableDate: '2026-05-01',
    lat: 40.8560, lng: -73.8880,
  },
  {
  ...
  },
  {
    ...
    url: 'https://streeteasy.com/building/222-east-202-street-bronx/5b',
    address: '222 East 202nd Street, #5B',
    borough: 'Bronx', neighborhood: 'Bedford Park', zip: '10458',
    price: 1600, bedrooms: 1, bathrooms: 1,
    description: 'Large rent-stabilized 1BR with hardwood floors throughout, large living room, queen-sized bedroom, and separate kitchen.',
    availableDate: '2026-04-01',
    lat: 40.8680, lng: -73.8870,
  },
];
